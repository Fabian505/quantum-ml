...
NOTEBOOKS = [
    ("01_iris_simulator.ipynb",                "iris", False, False, False),
    ("02_iris_noise.ipynb",                    "iris", True,  True,  False),
    ("03_iris_hardware_qsvm.ipynb",            "iris", False, True,  True),
    ("04_qsvm_rauschrobustheit.ipynb",         "iris", True,  True,  False),
    ("05_breast_cancer_simulator.ipynb",       "bc",   False, False, False),
    ("06_breast_cancer_noise.ipynb",           "bc",   True,  True,  False),
    ("07_vqc_konvergenz_analyse.ipynb",        "iris", True,  True,  False),
    ("08_vqc_noise_iris.ipynb",                "iris", True,  True,  False),
    ("09_vqc_hardware.ipynb",                  "both", False, True,  True),
    ("10_vqc_hyperparameter_iris.ipynb",       "iris", False, False, False),
    ("11_vqc_hyperparameter_bc.ipynb",         "bc",   False, False, False),
    ("12_qsvm_hardware_parameter_analyse.ipynb","both", True,  True,  False),
    ("13_vqc_hardware_parameter_analyse.ipynb","both", True,  True,  False),
    ("14_bitstring_visualisierung.ipynb",      "iris", False, False, False),
]
